          ...
          <main className="detail__row__work">
            <article className="detail__card">
              <aside className="detail__card__top">
                <ReactSVG src={detail01} alt={texts.Cards.graphic01Card} />
                <h2>{texts.Cards.subtitleFirst}</h2>
              </aside>

              <p>{texts.Cards.cardOne}</p>
            </article>

            <article className="detail__card">
              <aside className="detail__card__top">
                <ReactSVG src={detail02} alt={texts.Cards.graphic02Card} />
                <h2>{texts.Cards.subtitleSecond}</h2>
              </aside>
              <p>{texts.Cards.cardTwo}</p>
            </article>

            <article className="detail__card">
              <aside className="detail__card__top">
                <ReactSVG src={detail03} alt={texts.Cards.graphic03Card} />
                <h2>{texts.Cards.subtitleThree}</h2>
              </aside>
              <p>{texts.Cards.cardThree}</p>
            </article>
          </main>
          <ReactSVG
            src={circle__four}
